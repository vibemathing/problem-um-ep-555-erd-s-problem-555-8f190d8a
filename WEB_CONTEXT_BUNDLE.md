...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-555-erd-s-problem-555-8f190d8a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-555"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-555-erd-s-problem-555-8f190d8a-v1",
      "problem_contract_sha256": "ff9e091a709cc218591632a0f699ed4c1ddc2152284792d43153ae83cb0b7882",
      "problem_id": "problem:um-ep-555-erd-s-problem-555-8f190d8a",
      "route_id": "route:um-ep-555-erd-s-problem-555-8f190d8a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-555-erd-s-problem-555-8f190d8a-source-fidelity-01",
      "graph_id": "graph:um-ep-555-erd-s-problem-555-8f190d8a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-555-erd-s-problem-555-8f190d8a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-555-erd-s-problem-555-8f190d8a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $R(G;k)$ denote the minimal $m$ such that if the edges of $K_m$ are $k$-coloured then there is a monochromatic copy of $G$. Determine the value of $ R(C_{2n};k). $"
          },
          "statement_sha256": "d085cf467b1d04be19aede99f5c34e30d3b531771ecfea338104bc9911b89207"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-555-erd-s-problem-555-8f190d8a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-555-erd-s-problem-555-8f190d8a-root",
      "route_id": "route:um-ep-555-erd-s-problem-555-8f190d8a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-555-4fe28100a1fd",
        "url": "https://www.unsolvedmath.com/problems/EP-555"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
